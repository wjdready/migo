 ...
 * Date         : 2021-03-23 09:29:17
 * LastEditTime : 2021-03-24 21:41:40
 * FilePath     : /AWA5920/Module/lv_examples/src/lv_ex_style/lv_ex_style_11.c
 * Description  : 
 */
...
void lv_ex_style_11(void)
{
    ...
    lv_style_set_scale_grad_color(&style, LV_STATE_DEFAULT, LV_COLOR_RED);
    lv_style_set_scale_width(&style, LV_STATE_DEFAULT, 30);
    // lv_style_set_scale_border_width(&style, LV_STATE_DEFAULT, 1);
    lv_style_set_line_width(&style, LV_STATE_DEFAULT, 5);
